...
public class ControlPanel extends JPanel {
    ...
    private static List<SortEvent<Integer>> generateEvents(String sort, Integer[] arr) {
        System.out.println("generateEvents() called");
        switch (sort) {
            case "Selection":
    ...
    public ControlPanel(NoteIndices notes, ArrayPanel panel) {
        ...
        playButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                Integer[] sort_arr = notes.getNotes();
                List<SortEvent<Integer>> events = generateEvents((String) sorts.getSelectedItem(), sort_arr);
                
                // final sweep through sorted indices at end
